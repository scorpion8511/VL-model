...
def get_image_loader(urls, batch_size, num_workers, augment=False):
    t = [
    ...
    transform = torchvision.transforms.Compose(t)
...
def get_args():
    ...
    parser.add_argument(
        "--augment",
        action="store_true",
        help="Apply random data augmentation to training images",
    )
...
def main():
    ...
    if args.json_data:
        ...
        image_loader = get_image_loader(args.image_data, args.batch_size, args.num_workers, augment=args.augment)
